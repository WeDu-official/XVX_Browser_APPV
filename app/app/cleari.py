import os
import subprocess
folder_to_remove:str = f"C:\\Users\\{os.path.basename(os.environ['USERPROFILE'])}\\AppData\\Local\\maincognito"
...
o.close()
if d == '':
    subprocess.Popen('C:/WeDu/Python312/python.exe maincognito.py')